export const Colors = {
  ...
  info: "#2196F3", // Info messages and indicators

  // Others
  ripple: "rgba(0, 0, 0, 0.1)", // TouchableRipple effect

  gradients: {
    primary: ["#af1400", "#ff4d2e"], // Antique red → bright red-orange
    primarySoft: ["#ffe5e0", "#ffd1c7"], // Soft red tint
    accent: ["#F59E0B", "#D97706"], // Gold accent
    surface: ["#FFFFFF", "#F8FAFC"], // Light gray-white
  },
};
